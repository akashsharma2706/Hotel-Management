...
urlpatterns = [
    ...
    path('hotel/<str:hotel_id>/room/add/', RoomListCreateView.as_view(), name='room_create'),
    ...
    path('hotel/<str:hotel_id>/reviews/add/', ReviewListCreateView.as_view(), name='add_review'),
